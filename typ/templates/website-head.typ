  ...
  if target() == "html" {
    html.elem("html", attrs: (lang: "en"), {
      html.elem("head", {
        ...
        html.elem("style", "body{max-width:60em!important;margin:auto}.smallcaps{font-variant:small-caps}h1{font-variant:small-caps}nav[role=doc-toc] li>div{display:inline}nav[role=doc-toc] ol{padding-left:1.5em}nav[role=doc-toc]>ol{padding-left:0}")
        // Favicon
